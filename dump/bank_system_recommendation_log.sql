...
CREATE TABLE `recommendation_log` (
  ...
  PRIMARY KEY (`rec_id`),
  KEY `FKaw7y9bt6u923pmlxoiypn88ug` (`customer_id`),
  KEY `FKajhkkgukdhcrd2c0s9bfemnv0` (`product_id`),
  CONSTRAINT `FKajhkkgukdhcrd2c0s9bfemnv0` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`),
  CONSTRAINT `FKaw7y9bt6u923pmlxoiypn88ug` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`)
...
INSERT INTO `recommendation_log` VALUES (1,_binary '\0',NULL,'e',1.00,'2025-10-13 22:31:18.880058',NULL,NULL);
